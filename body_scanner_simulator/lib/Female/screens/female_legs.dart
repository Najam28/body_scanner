...
class FemaleLegs extends StatefulWidget {
  const FemaleLegs({super.key});

  @override
  State<FemaleLegs> createState() => _FemaleLegsState();
}

class _FemaleLegsState extends State<FemaleLegs>
          ...
          setState(() {
            ...
            Future.delayed(const Duration(seconds: 5), () async {
              Navigator.of(context).push(MaterialPageRoute(
                builder: (context) =>
                    ScanImage(image: Image.asset('assets/x_legs.png')),
              ));
            });
          });
        } else {
