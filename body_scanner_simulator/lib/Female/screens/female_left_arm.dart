...
class FemaleLeftArm extends StatefulWidget {
  const FemaleLeftArm({super.key});

  @override
  State<FemaleLeftArm> createState() => _FemaleLeftArmState();
}

class _FemaleLeftArmState extends State<FemaleLeftArm>
          ...
          setState(() {
            ...
            Future.delayed(const Duration(seconds: 5), () async {
              Navigator.of(context).push(MaterialPageRoute(
                builder: (context) =>
                    ScanImage(image: Image.asset('assets/x_left.png')),
              ));
            });
          });
        } else {
